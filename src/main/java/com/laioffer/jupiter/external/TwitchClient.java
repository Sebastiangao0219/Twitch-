...
public class TwitchClient {
    private static final String TOKEN = "Bearer as7dvxv35pwfhhktc2ttryuxrza6h9";
    private static final String CLIENT_ID = "1ah0zm8j25yama2o17xpmcvfvv8r36";
    ...
    public Map<String, List<Item>> searchItems(String gameId) throws TwitchException {
        //one gameID can have multiple typed items
